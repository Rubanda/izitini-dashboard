            ...
            <div className=' bg-white p-4 rounded-lg mb-4'>
                <div className='grid gap-4 grid-cols-1 md:grid-cols-4'>
                    ...
                    <div className='flex items-center justify-center mt-5 w-full'>
                        <button
                            type='submit'
                            className='flex items-center justify-center py-3 px-12 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-light-blue hover:bg-middle-blue focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500'
                        >
                            SEARCH
                        </button>
                    </div>
